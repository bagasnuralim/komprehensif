<?php
    ...
    $data = null;
    if(isset($_GET['id'])) {
        $data = $pengarsipan->getDetailbm($_GET['id']);
    }
?>
    ...
    <?php if ($data) :?>
        ...
        <table class="table table-bordered table-hover table-striped tablesorter" align="center">
            ...
            <tr>
                <th class="text-left" width="300px">Kode Surat</th>
            ...
            <tr>
                <th class="text-left">Sumber Surat</th>
                <td> <?php echo $data["sumber_surat"] ?> </td>
            </tr>
            <tr>
            ...
            <tr>
                <th class="text-left">No Surat Dari Sumber</th>
                <td> <?php echo $data["no_surat_sumber"] ?> </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><a href="<?php echo $data['file']; ?>" class="btn btn-primary">Download</a> <a href="application.php?page=databm" class="btn btn-success">Kembali</a></td>
            </tr>              
        </table>
