  ...
  <div class="row">
    <div class="col-lg-12">
      <ol class="breadcrumb">
        ...
        <li><i class="fa fa-book"></i> Data Barang Keluar</li>
      </ol>
		<div class="col-lg-7">
				<?php 
	  	...
	  	<div class="col-lg-5">
	  	<form method="GET" action="controllers/data/prosesgetbk.php">
	  ...
	  <div class="col-lg-12">
        <div class="table-responsive">
			<table class="table table-bordered table-hover table-striped tablesorter">
            	<tr>
                	<th width="200"><center>No Surat</center></th>
				...
				if(isset($_GET['nama_surat'])){
					$cari = $_GET['nama_surat'];
					$data = mysql_query("SELECT * FROM upload_bk WHERE nama_file LIKE '%".$cari."%'");
				}else{
					$data = mysql_query("SELECT * FROM upload_bk");
				}
				...
				<tr>
					...
					<td width="50" align="center">
						<form action="controllers/detail/idbk.php" method="get">
